...
PARAM$finalmodel$num_iterations <- 287
PARAM$finalmodel$learning_rate <- 0.0531565098973305
PARAM$finalmodel$feature_fraction <- 0.850238741562664
PARAM$finalmodel$min_data_in_leaf <- 1390
PARAM$finalmodel$num_leaves <- 138
