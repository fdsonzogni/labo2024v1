...
PARAM$finalmodel$num_iterations <- 586
PARAM$finalmodel$learning_rate <- 0.0107419994869317
PARAM$finalmodel$feature_fraction <- 0.20923543003082
PARAM$finalmodel$min_data_in_leaf <- 1015
PARAM$finalmodel$num_leaves <- 186
