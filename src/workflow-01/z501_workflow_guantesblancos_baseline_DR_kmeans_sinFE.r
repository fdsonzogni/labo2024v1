...
FE_historia_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-01/z541_FE_historia_fds.r"
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT00035", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA00035", "DT00035" )

  DR_drifting_guantesblancos( "DR00035", "CA00035" )
  FE_historia_guantesblancos( "FE00035", "DR00035" )

  TS_strategy_guantesblancos_202109( "TS00035", "FE00035" )

  HT_tuning_guantesblancos( "HT00035", "TS00035" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ00035", c("HT00035", "TS00035") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS00036", "FE00035" )

  HT_tuning_guantesblancos( "HT00036", "TS00036" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ00036", c("HT00036", "TS00036") )
