...
DR_drifting_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-01/z531_DR_corregir_drifting_fds.r"
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT00029", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA00029", "DT00029" )

  DR_drifting_guantesblancos( "DR00029", "CA00029" )
  FE_historia_guantesblancos( "FE00029", "DR00029" )

  TS_strategy_guantesblancos_202109( "TS00029", "FE00029" )

  HT_tuning_guantesblancos( "HT00029", "TS00029" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ00029", c("HT00029", "TS00029") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS00030", "FE00029" )

  HT_tuning_guantesblancos( "HT00030", "TS00030" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ00030", c("HT00030", "TS00030") )
...
corrida_guantesblancos_202109( "gb27" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb28" )
