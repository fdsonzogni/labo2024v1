...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT00025", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA00025", "DT00025" )

  DR_drifting_guantesblancos( "DR00025", "CA00025" )
  FE_historia_guantesblancos( "FE00025", "DR00025" )

  TS_strategy_guantesblancos_202109( "TS00025", "FE00025" )

  HT_tuning_guantesblancos( "HT00025", "TS00025" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ00025", c("HT00025", "TS00025") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS00026", "FE00025" )

  HT_tuning_guantesblancos( "HT00026", "TS00026" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ00026", c("HT00026", "TS00026") )
...
corrida_guantesblancos_202109( "gb22" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb23" )
