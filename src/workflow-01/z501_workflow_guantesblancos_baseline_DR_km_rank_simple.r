...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT00039", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA00039", "DT00039" )

  DR_drifting_guantesblancos( "DR00039", "CA00039" )
  FE_historia_guantesblancos( "FE00039", "DR00039" )

  TS_strategy_guantesblancos_202109( "TS00039", "FE00039" )

  HT_tuning_guantesblancos( "HT00039", "TS00039" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ00039", c("HT00039", "TS00039") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS00040", "FE00039" )

  HT_tuning_guantesblancos( "HT00040", "TS00040" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ00040", c("HT00040", "TS00040") )
...
corrida_guantesblancos_202109( "gb35" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb36" )
