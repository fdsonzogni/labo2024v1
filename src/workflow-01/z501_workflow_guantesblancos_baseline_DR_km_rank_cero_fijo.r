...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT00031", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA00031", "DT00031" )

  DR_drifting_guantesblancos( "DR00031", "CA00031" )
  FE_historia_guantesblancos( "FE00031", "DR00031" )

  TS_strategy_guantesblancos_202109( "TS00031", "FE00031" )

  HT_tuning_guantesblancos( "HT00031", "TS00031" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ00031", c("HT00031", "TS00031") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS00032", "FE00031" )

  HT_tuning_guantesblancos( "HT00032", "TS00032" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ00032", c("HT00032", "TS00032") )
