...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT00033", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA00033", "DT00033" )

  DR_drifting_guantesblancos( "DR00033", "CA00033" )
  FE_historia_guantesblancos( "FE00033", "DR00033" )

  TS_strategy_guantesblancos_202109( "TS00033", "FE00033" )

  HT_tuning_guantesblancos( "HT00033", "TS00033" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ00033", c("HT00033", "TS00033") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS00034", "FE00033" )

  HT_tuning_guantesblancos( "HT00034", "TS00034" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ00034", c("HT00034", "TS00034") )
...
corrida_guantesblancos_202109( "gb29" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb30" )
