...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT00037", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA00037", "DT00037" )

  DR_drifting_guantesblancos( "DR00037", "CA00037" )
  FE_historia_guantesblancos( "FE00037", "DR00037" )

  TS_strategy_guantesblancos_202109( "TS00037", "FE00037" )

  HT_tuning_guantesblancos( "HT00037", "TS00037" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ00037", c("HT00037", "TS00037") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS00038", "FE00037" )

  HT_tuning_guantesblancos( "HT00038", "TS00038" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ00038", c("HT00038", "TS00038") )
