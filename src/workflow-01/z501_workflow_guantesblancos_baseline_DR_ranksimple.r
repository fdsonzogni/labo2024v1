...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT00027", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA00027", "DT00027" )

  DR_drifting_guantesblancos( "DR00027", "CA00027" )
  FE_historia_guantesblancos( "FE00027", "DR00027" )

  TS_strategy_guantesblancos_202109( "TS00027", "FE00027" )

  HT_tuning_guantesblancos( "HT00027", "TS00027" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ00027", c("HT00027", "TS00027") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS00028", "FE00027" )

  HT_tuning_guantesblancos( "HT00028", "TS00028" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ00028", c("HT00028", "TS00028") )
...
corrida_guantesblancos_202109( "gb23" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb24" )
