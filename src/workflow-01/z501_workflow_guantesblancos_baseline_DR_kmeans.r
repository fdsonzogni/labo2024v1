...
DR_drifting_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-01/z531_DR_corregir_drifting_fds_kmeans.r"
...
HT_tuning_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    num_leaves = c( 500L, 1024L,  "integer" ),
    min_data_in_leaf = c( 500L, 2000L, "integer" )
  )
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT00023", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA00023", "DT00023" )

  DR_drifting_guantesblancos( "DR00023", "CA00023" )
  FE_historia_guantesblancos( "FE00023", "DR00023" )

  TS_strategy_guantesblancos_202109( "TS00023", "FE00023" )

  HT_tuning_guantesblancos( "HT00023", "TS00023" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ00023", c("HT00023", "TS00023") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS00024", "FE00023" )

  HT_tuning_guantesblancos( "HT00024", "TS00024" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ00024", c("HT00024", "TS00024") )
...
corrida_guantesblancos_202109( "gb20" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb21" )
