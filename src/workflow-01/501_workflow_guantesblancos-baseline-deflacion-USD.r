...
TS_strategy_guantesblancos_202107 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(202105, 202104, 202103, 202101, 202101, 202012, 202011, 202010, 202009)
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_BL_deflacion_usd", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_BL_deflacion_usd", "DT0001_BL_deflacion_usd" )

  DR_drifting_guantesblancos( "DR0001_BL_deflacion_usd", "CA0001_BL_deflacion_usd" )
  FE_historia_guantesblancos( "FE0001_BL_deflacion_usd", "DR0001_BL_deflacion_usd" )

  TS_strategy_guantesblancos_202109( "TS0001_BL_deflacion_usd", "FE0001_BL_deflacion_usd" )

  HT_tuning_guantesblancos( "HT0001_BL_deflacion_usd", "TS0001_BL_deflacion_usd" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_BL_deflacion_usd", c("HT0001_BL_deflacion_usd","TS0001_BL_deflacion_usd") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_BL_deflacion_usd", "FE0001_BL_deflacion_usd" )

  HT_tuning_guantesblancos( "HT0002_BL_deflacion_usd", "TS0002_BL_deflacion_usd" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_BL_deflacion_usd", c("HT0002_BL_deflacion_usd", "TS0002_BL_deflacion_usd") )
...
corrida_guantesblancos_202109( "gb01_BL_deflacion_usd" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_BL_deflacion_usd" )
